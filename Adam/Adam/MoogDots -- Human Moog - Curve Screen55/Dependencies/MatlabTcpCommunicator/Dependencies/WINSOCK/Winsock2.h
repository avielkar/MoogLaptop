...
extern C {
  ...
  Basic system type definitions, taken from the BSD file systypes.h.
...
#define FD_ISSET(fd, set) __WSAFDIsSet((SOCKET)(fd), (fd_set FAR )(set))
  ...
  Structure used in select() call, taken from the BSD file systime.h.
...
#define timerclear(tvp)         (tvp)-tv_sec = (tvp)-tv_usec = 0
  ...
  to encode the inout status of the parameter; for now
...
#define IOC_INOUT       (IOC_INIOC_OUT)
...
#define FIONBIO     _IOW('f', 126, u_long)  setclear non-blocking io 
#define FIOASYNC    _IOW('f', 125, u_long)  setclear async io 
...
struct  protoent {
  ...
  Per RFC 790, September 1981, taken from the BSD file netinetin.h.
...
#define IPPROTO_MAX             256
  ...
  Portsocket numbers network standard functions
...
#define IPPORT_MTP              57
  ...
  Portsocket numbers host specific functions
...
typedef struct WSAData {
  ...
  taken from the BSD file syssocket.h.
...
struct  linger {
        u_short l_onoff;                 option onoff 
        u_short l_linger;                linger time 
};


  Level number for (getset)sockopt() to apply to socket itself.
...
#define MSG_INTERRUPT   0x10             sendrecv in the interrupt context 
...
#define SERVICE_TYPE_VALUE_IPXPORTW     LIpxSocket
#define SERVICE_TYPE_VALUE_SAPIDA        SapId
#define SERVICE_TYPE_VALUE_SAPIDW       LSapId

#define SERVICE_TYPE_VALUE_TCPPORTA      TcpPort
#define SERVICE_TYPE_VALUE_TCPPORTW     LTcpPort

#define SERVICE_TYPE_VALUE_UDPPORTA      UdpPort
#define SERVICE_TYPE_VALUE_UDPPORTW     LUdpPort

#define SERVICE_TYPE_VALUE_OBJECTIDA     ObjectId
#define SERVICE_TYPE_VALUE_OBJECTIDW    LObjectId
...
typedef enum _WSAESETSERVICEOP
{
  ...
  Service InstallationRemoval Data Types.
...
(WSAAPI  LPFN_WSAASYNCSELECT)(
  ...
  WSAAccept() and overlapped IO completion routine.
